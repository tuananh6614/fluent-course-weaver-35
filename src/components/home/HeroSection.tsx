          ...
          <div className="space-y-8 animate-fade-in">
            <div>
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                Truy cập các khóa học chất lượng cao, bài học tương tác và đánh giá toàn diện để đạt được mục tiêu giáo dục và nghề nghiệp của bạn.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-6 md:gap-12">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">500+ Khóa Học</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="h-5 w-5 text-primary" />
                <span className="font-medium">10k+ Học Viên</span>
              </div>
              <div className="flex items-center gap-2">
                <Award className="h-5 w-5 text-primary" />
                <span className="font-medium">Giảng Viên Chuyên Nghiệp</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-fade-in animation-delay-300">
            <div className="relative z-10 aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border-8 border-white">
              <img
                ...
                alt="Học viên học tập cùng nhau"
            ...
            <div className="absolute -bottom-6 -left-6 z-20 bg-white p-4 rounded-xl shadow-lg card-shadow animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium">Học Tập Tương Tác</div>
                  <div className="text-sm text-muted-foreground">Tương tác với tài liệu</div>
                </div>
              </div>
            </div>
            <div className="absolute -top-6 -right-6 z-20 bg-white p-4 rounded-xl shadow-lg card-shadow animate-float animation-delay-500">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium">Nhận Chứng Chỉ</div>
                  <div className="text-sm text-muted-foreground">Thể hiện kỹ năng của bạn</div>
                </div>
              </div>
            </div>
